    ...
    <div class="container">
        <div class="section-left">
            <div class="left-top-menu">
                <div class="lt-menu-name">
                    ...
                    <a href="${ctx}/user/relist" class="more">
                        更多
                    </a>
                </div>
        ...
        <div class="section-right">
            ...
            <div class="tag">
                ...
                <ul>
                    <li><a href="${ctx}/user/relist">轻音乐</a> </li>
                    <li><a href="${ctx}/user/relist">日韩流行</a> </li>
                    <li><a href="${ctx}/user/relist">排行榜</a> </li>
                    <li><a href="${ctx}/user/relist">新歌速递</a> </li>
                    <li><a href="${ctx}/user/relist">伤感</a> </li>
                    <li><a href="${ctx}/user/relist">下午茶</a> </li>
                    <li><a href="${ctx}/user/relist">说唱</a> </li>
                    <li><a href="${ctx}/user/relist">爵士</a> </li>
                    <li><a href="${ctx}/user/relist">影视原声</a> </li>
                    <li><a href="${ctx}/user/relist">校园风</a> </li>
                </ul>
            </div>
            <div class="right-top-menu">
                <div class="rt-menu-name">
                    <ul>
                        ...
                        <li><a href="${ctx}/user/relist">更多</a> </li>
                    </ul>
                </div>
