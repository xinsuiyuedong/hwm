        ...
        <div class="content_right">
            <ul>
                <li>
                    ...
                    <p class="dec">
                        <a href="${ctx}/user/detailedlist" title="【欧美】当民谣邂逅电影" class="tit">【欧美】当民谣邂逅电影</a>
                    </p>
                </li>
                <li>
                    <div>
                    ...
                    <p class="dec">
                        <a href="${ctx}/user/detailedlist" title="民谣中的节奏担当——手鼓" class="tit">民谣中的节奏担当——手鼓</a>
                    </p>
                </li>
                <li>
                    <div>
                ...
                <li>
                    ...
                    <p class="dec">
                        <a href="${ctx}/user/detailedlist" title="我后来见你独峙酸忧" class="tit">我后来见你独峙酸忧</a>
                    </p>
                </li>
                <li>
                    <div>
                    ...
                    <p class="dec">
                        <a href="${ctx}/user/detailedlist" title="民谣·低吟浅唱一段过往" class="tit">民谣·低吟浅唱一段过往</a>
                    </p>
                </li>
                <li>
                    <div>
                    ...
                    <p class="dec">
                        <a href="${ctx}/user/detailedlist" title="民谣的人啊，你到底遇过几个丫头" class="tit">民谣的人啊，你到底遇过几个丫头</a>
                    </p>
                </li>
                <li>
                    <div>
                    ...
                    <p class="dec">
                        <a href="${ctx}/user/detailedlist" title="扫弦民谣|抚平残心中凋烟泣露的唏嘘" class="tit">扫弦民谣|抚平残心中凋烟泣露的唏嘘</a>
                    </p>
                </li>
                <li>
                    <div>
                    ...
                    <p class="dec">
                        <a href="${ctx}/user/detailedlist" title="【翻唱改编合唱】" class="tit">【翻唱改编合唱】</a>
                    </p>
                </li>
                <li>
                    <div>
                    ...
                    <p class="dec">
                        <a href="${ctx}/user/detailedlist" title="民谣歌曲中的童声" class="tit">民谣歌曲中的童声</a>
                    </p>
                </li>
                <li>
                    <div>
                    ...
                    <p class="dec">
                        <a href="${ctx}/user/detailedlist" title="Forza Horizon 3 OST" class="tit">Forza Horizon 3 OST</a>
                    </p>
                </li>
                <li>
                    <div>
                    ...
                    <p class="dec">
                        <a href="${ctx}/user/detailedlist" title="全球最好听法语系强势来袭 " class="tit">全球最好听法语系强势来袭 </a>
                    </p>
                </li>
                <li>
                    <div>
                    ...
                    <p class="dec">
                        <a href="${ctx}/user/detailedlist" title="全球最好听英语系强势来袭" class="tit">全球最好听英语系强势来袭</a>
                    </p>
                </li>
                <li>
                    <div>
                    ...
                    <p class="dec">
                        <a href="${ctx}/user/detailedlist" title="爱の诗篇" class="tit">爱の诗篇</a>
                    </p>
                </li>
                <li>
                    <div>
                    ...
                    <p class="dec">
                        <a href="${ctx}/user/detailedlist" title="日本原创歌手集" class="tit">日本原创歌手集</a>
                    </p>
                </li>
                <li>
                    <div>
                    ...
                    <p class="dec">
                        <a href="${ctx}/user/detailedlist" title="清恋SEIREN" class="tit">清恋SEIREN</a>
                    </p>
                </li>
            </ul>
